...
PHOTO = {
    "home-event":      ("assets/images/home-event-1920.jpg", "assets/images/home-event-960.jpg", 1920, 1280),
    "about-photo":     ("assets/images/about-photo-1600.jpg", "assets/images/about-photo-800.jpg", 1600, 1066),
    "demo-day":        ("assets/images/demo-day-1600.jpg", "assets/images/demo-day-800.jpg", 1066, 1600),
    "community-photo": ("assets/images/community-photo-1600.jpg", "assets/images/community-photo-800.jpg", 1066, 1600),
}
    ...
    <div class="wrap">
      <div class="hero__grid">
        ...
        <div class="hero__media" data-reveal data-delay="0.2">
          <img src="{big}" srcset="{small} 800w, {big} 1600w"
...
def write(filename, title, desc, body, current, extra_head="", extra_js=""):
    html = (head(title, desc, filename, extra_head) + chrome(current) + body
