...
<link rel="stylesheet" href="css/vha-v2.css">
{extra}</head>
<body>
...
<script src="js/vha-network.js"></script>
<script src="js/vha-v2.js"></script>
"""
...
def page_home():
  ...
  <section class="section mode-dark mode-dark--black" id="platform">
    <div class="wrap">
...
def page_accelerator():
  ...
  <!-- Phases -->
  <section class="section mode-dark mode-dark--black" id="phases">
    <div class="wrap">
...
def page_studio():
  ...
  <section class="section mode-dark mode-dark--black">
    <div class="wrap">
...
""" + APPLY_FORM
    return write("apply.html",
                 ...
                 body, "apply.html",
                 extra_js='<script src="js/vha-apply.js"></script>\n')
